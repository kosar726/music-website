    ...
    < <nav class="navbar navbar-expand-lg bg-dark navbar-dark  background-black shadow-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="upload.php" class="nav-link">پخش آهنگ های شما</a></li>
            </ul>
           <form method="GET" action="search.php" class="form-inline ml-md-5 ml-lg-5 my-2 my-lg-0">
                ...
                <button class="btn btn-outline-light my-2 my-sm-0 mr-2" type="submit"><i class="fas fa-search"></i></button>
            </form>
        </div>
    </nav>