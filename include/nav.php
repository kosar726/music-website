      ...
      <div class="row pt-md-5 mb-md-5">
        ...
        <div class="col-sm-6 col-lg-3 p-2">
          <div class="card shadow">
            <div class="card-body">
             <a href="./rock/bohemian rhaspody.php" class="black">
              <div class="card-header font-weight-bold text-center bg-white">
                Bohemian Rhapsody- Queen
               </div>
              </a>
              <a href="./rock/bohemian rhaspody.php">
                <div class="d-flex justify-content-between">
                  <img src="./rock/image/Queen - Bohemian Rhapsody.jpg" />
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="col-sm-6 col-lg-3 p-2">
          <div class="card shadow">
            <div class="card-body">
                <a href="./pop/Old Me.php" class="black">
                  <div class="card-header font-weight-bold text-center bg-white">
                    Old Me- 5SOS
                  </div>
                </a>
                <a href="./pop/Old Me.php">
                  <div class="d-flex justify-content-between">
                    <img src="./pop/image/5 seconds of summer - Old Me.jpg" />
                  </div>
                </a>
            </div>
          </div>
        ...
        <div class="col-sm-6 col-lg-3 p-2">
          <div class="card shadow">
            <div class="card-body">
                <a href="./hiphop/the real slim shady.php" class="black">
                  <div class="card-header font-weight-bold text-center bg-white" style="font-size: 15px;">
                    The Real Slim Shady - Eminem 
                  </div>
                </a>
                <a href="./hiphop/the real slim shady.php">
                  <div class="d-flex justify-content-between">
                    <img src="./hiphop/image/Eminem - The Real Slim Shady.jpg" />
                  </div>
                </a>
            </div>
          </div>
        ...
        <div class="col-sm-6 col-lg-3 p-2">
          <div class="card shadow">
            <div class="card-body">
              <a href="./alternative/Dance Monkey.php" class="black">
                <div class="card-header font-weight-bold text-center bg-white">
                  dance monkey - tones and I
                </div> 
              </a>
              <a href="./alternative/Dance Monkey.php">
                <div class="d-flex justify-content-between">
                <img src="./alternative/image/tones and I - dance monkey.jpg" />   
                </div>              
              </a>
            </div>
          </div>
